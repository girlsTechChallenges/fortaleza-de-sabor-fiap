...
class DeleteMenuItemUseCaseTest {
   ...
   void shouldReturnEmptyOptionalWhenMenuItemNotFound() {
       ...
       // Act
       Optional<MenuItem> result = MenuItemUseCase.deleteById(nonExistentId);
   ...
   void shouldHandleNullIdGracefully() {
       ...
       // Act
       Optional<MenuItem> result = MenuItemUseCase.deleteById(nullId);
   ...
   void shouldPropagateRepositoryExceptions() {
       ...
       RuntimeException thrownException = assertThrows(
           ...
           () -> MenuItemUseCase.deleteById(validId),
