...
import com.br.fiap.fortaleza.sabor.infrastructure.exception.GlobalExceptionHandler;
...
class GlobalExceptionHandlerTest {
   ...
   void shouldHandleUserNotFoundException() {
       ...
       // Act
       ResponseEntity<ApiErrorMessage> response = globalExceptionHandler.handleUserNotFoundException(exception);
   ...
   void shouldHandleMethodArgumentNotValidException() {
       ...
       // Act
       ResponseEntity<ApiErrorMessage> response = globalExceptionHandler.handleValidationException(methodArgumentNotValidException);
   ...
   void shouldHandleGeneralExceptions() {
       ...
       // Act
       ResponseEntity<ApiErrorMessage> response = globalExceptionHandler.handleGenericException(exception);
