...
class UpdateUserUseCaseTest {
   ...
   void shouldUpdateUserSuccessfullyWhenUserExists() {
       ...
       // Act
       Optional<User> result = UserUseCase.update(userId, userToUpdate);
   ...
   void shouldReturnEmptyOptionalWhenUserNotFound() {
       ...
       // Act
       Optional<User> result = UserUseCase.update(nonExistentId, userToUpdate);
   ...
   void shouldHandleNullUserGracefully() {
       ...
       assertThrows(NullPointerException.class,
           () -> UserUseCase.update(validId, nullUser),
   ...
   void shouldHandleNullIdGracefully() {
       ...
       // Act
       Optional<User> result = UserUseCase.update(nullId, userToUpdate);
   ...
   void shouldPropagateRepositoryExceptions() {
       ...
       RuntimeException thrownException = assertThrows(
           ...
           () -> UserUseCase.update(validId, userToUpdate),
