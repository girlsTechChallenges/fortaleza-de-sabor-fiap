...
import com.br.fiap.fortaleza.sabor.application.usecase.user.UserUseCase;
...
class GetUserUseCaseTest {
   ...
   void shouldReturnUserByIdWhenUserExists() {
       ...
       // Act
       Optional<User> result = userUseCase.getById(validId);
   ...
   void shouldReturnEmptyOptionalWhenUserNotFoundById() {
       ...
       // Act
       Optional<User> result = userUseCase.getById(invalidId);
   ...
   void shouldHandleNullIdGracefully() {
       ...
       // Act
       Optional<User> result = userUseCase.getById(nullId);
