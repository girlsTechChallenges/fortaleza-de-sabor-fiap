...
//class MenuItemRepositoryJpaAdapterTest {
//
//    @InjectMocks
//    private MenuItemRepositoryPortJpa menuItemRepositoryJpa;
//
//    @Mock
...
//
//        // Act
//        List<MenuItem> result = menuItemRepositoryAdapter.getAll();
//
//        // Assert
...
//
//        verify(menuItemRepositoryAdapter, times(1)).findAll();
...
//        when(menuItemRepositoryAdapter.findAll()).thenReturn(emptyList);
//
//        // Act
//        List<MenuItem> result = menuItemRepositoryAdapter.getAll();
//
...
//        when(menuItemRepositoryAdapter.save(entityToSave)).thenReturn(savedEntity);
//        when(menuMapper.toMenuItemDomain(savedEntity)).thenReturn(expectedResult);
//
//        // Act
//        MenuItem result = menuItemRepositoryAdapter.save(menuItemToSave);
//
//        // Assert
//        assertNotNull(result, "Result should not be null");
...
//        verify(menuItemRepositoryAdapter, times(1)).save(entityToSave);
...
//
//        when(menuItemRepositoryAdapter.findById(validId)).thenReturn(Optional.of(entity));
//        when(menuMapper.toMenuItemDomain(entity)).thenReturn(expectedMenuItem);
//
//        // Act
//        Optional<MenuItem> result = menuItemRepositoryAdapter.getById(validId);
//
//        // Assert
//        assertTrue(result.isPresent(), "Result should be present");
//        assertEquals(expectedMenuItem, result.get(), "Should return correct menu item");
//
//        verify(menuItemRepositoryAdapter, times(1)).findById(validId);
...
//        when(menuItemRepositoryAdapter.findById(invalidId)).thenReturn(Optional.empty());
//
//        // Act & Assert
//        MenuNotFoundException exception = assertThrows(MenuNotFoundException.class,
//            () -> menuItemRepositoryAdapter.getById(invalidId),
...
//
//        verify(menuItemRepositoryAdapter, times(1)).findById(invalidId);
//        verifyNoInteractions(menuMapper);
//    }
//
//    @Test
...
//        MenuItem expectedResult = TestDataBuilder.createValidMenuItem();
//
//        when(menuItemRepositoryAdapter.findById(itemId)).thenReturn(Optional.of(existingEntity));
//        when(menuItemRepositoryAdapter.save(any(MenuItemsEntity.class))).thenReturn(savedEntity);
//        when(menuMapper.toMenuItemDomain(savedEntity)).thenReturn(expectedResult);
//
//        // Act
//        Optional<MenuItem> result = menuItemRepositoryAdapter.update(itemId, updatedMenuItem);
//
//        // Assert
//        assertTrue(result.isPresent(), "Result should be present");
//        assertEquals(expectedResult, result.get(), "Should return updated menu item");
//
//        verify(menuItemRepositoryAdapter, times(1)).findById(itemId);
//        verify(menuItemRepositoryAdapter, times(1)).save(any(MenuItemsEntity.class));
//        verify(menuMapper, times(1)).toMenuItemDomain(savedEntity);
//    }
//
//    @Test
...
//        MenuItem updatedMenuItem = TestDataBuilder.createValidMenuItem();
//
//        when(menuItemRepositoryAdapter.findById(nonExistentId)).thenReturn(Optional.empty());
//
//        // Act & Assert
//        MenuNotFoundException exception = assertThrows(MenuNotFoundException.class,
//            () -> menuItemRepositoryAdapter.update(nonExistentId, updatedMenuItem),
//            "Should throw MenuNotFoundException when menu item not found for update");
//
//        assertTrue(exception.getMessage().contains(nonExistentId.toString()),
//            "Exception message should contain the invalid ID");
//
//        verify(menuItemRepositoryAdapter, times(1)).findById(nonExistentId);
//        verify(menuItemRepositoryAdapter, never()).save(any(MenuItemsEntity.class));
//        verifyNoInteractions(menuMapper);
//    }
//
//    @Test
...
//
//        when(menuItemRepositoryAdapter.findById(itemId)).thenReturn(Optional.of(existingEntity));
//        doNothing().when(menuItemRepositoryAdapter).deleteById(itemId);
//        when(menuMapper.toMenuItemDomain(existingEntity)).thenReturn(expectedDeletedItem);
//
//        // Act
//        Optional<MenuItem> result = menuItemRepositoryAdapter.deleteById(itemId);
//
//        // Assert
...
//
//        verify(menuItemRepositoryAdapter, times(2)).findById(itemId); // Called twice in deleteById method
//        verify(menuItemRepositoryAdapter, times(1)).deleteById(itemId);
...
//            () -> menuItemRepositoryAdapter.deleteById(nonExistentId)
//        );
//
...
//        when(menuItemRepositoryAdapter.findAll()).thenThrow(new RuntimeException(errorMessage));
//
//        // Act & Assert
//        RuntimeException exception = assertThrows(RuntimeException.class,
//            () -> menuItemRepositoryAdapter.getAll(),
