...
class DeleteUserUseCaseTest {
   ...
   void shouldReturnEmptyOptionalWhenUserNotFound() {
       ...
       // Act
       Optional<User> result = userUseCase.deleteById(nonExistentId);
   ...
   void shouldHandleNullIdGracefully() {
       ...
       // Act
       Optional<User> result = userUseCase.deleteById(nullId);
   ...
   void shouldPropagateRepositoryExceptions() {
       ...
       RuntimeException thrownException = assertThrows(
           ...
           () -> userUseCase.deleteById(validId),
   ...
   void shouldHandleEdgeCaseWithZeroId() {
       ...
       // Act
       Optional<User> result = userUseCase.deleteById(zeroId);
