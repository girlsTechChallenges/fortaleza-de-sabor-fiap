...
class RestaurantControllerTest {
    ...
    void shouldCreateRestaurantSuccessfully() throws Exception {
        ...
        when(createRestaurantUseCase.save(any(Restaurant.class)))
                .thenReturn(restaurant);
        ...
        verify(createRestaurantUseCase, times(1)).save(any(Restaurant.class));
    ...
    void shouldReturnBadRequestForInvalidInput() throws Exception {
        ...
        verify(createRestaurantUseCase, never()).save(any());
    }
