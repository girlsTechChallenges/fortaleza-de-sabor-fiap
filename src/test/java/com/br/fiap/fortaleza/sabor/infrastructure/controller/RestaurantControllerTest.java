...
//
//import com.br.fiap.fortaleza.sabor.application.usecase.restaurant.RestaurantUseCase;
...
//        when(restaurantUseCase.save(any(Restaurant.class)))
//                .thenReturn(restaurant);
...
//        when(restaurantMapper.toRestaurantDomain(any(RestaurantRequestDto.class)))
//                .thenReturn(restaurant);
//        when(updateRestaurantUseCase.update(eq(restaurantId), any(Restaurant.class)))
//                .thenReturn(restaurant);
//        when(restaurantMapper.toRestaurantResponseDto(any(Restaurant.class)))
//                .thenReturn(restaurantResponseDto);
//
...
//
//        verify(restaurantMapper, times(1)).toRestaurantDomain(any(RestaurantRequestDto.class));
//        verify(updateRestaurantUseCase, times(1)).update(eq(restaurantId), any(Restaurant.class));
//        verify(restaurantMapper, times(1)).toRestaurantResponseDto(any(Restaurant.class));
//    }
//
//    @Test
...
//
//        verify(restaurantUseCase, never()).save(any());
//    }
//
//    @Test
...
//                .andExpect(status().isBadRequest());
//
//        verify(updateRestaurantUseCase, never()).update(any(), any());
//    }
//}
