...
class UpdateMenuItemUseCaseTest {
   ...
   void shouldUpdateMenuItemSuccessfullyWhenItemExists() {
       ...
       // Act
       Optional<MenuItem> result = menuItemUseCase.update(menuItemId, menuItemToUpdate);
   ...
   void shouldReturnEmptyOptionalWhenMenuItemNotFound() {
       ...
       // Act
       Optional<MenuItem> result = menuItemUseCase.update(nonExistentId, menuItemToUpdate);
   ...
   void shouldHandleNullMenuItemGracefully() {
       ...
       // Act
       Optional<MenuItem> result = menuItemUseCase.update(validId, nullMenuItem);
   ...
   void shouldHandleNullIdGracefully() {
       ...
       // Act
       Optional<MenuItem> result = menuItemUseCase.update(nullId, menuItemToUpdate);
   ...
   void shouldPropagateRepositoryExceptions() {
       ...
       RuntimeException thrownException = assertThrows(
           ...
           () -> menuItemUseCase.update(validId, menuItemToUpdate),
