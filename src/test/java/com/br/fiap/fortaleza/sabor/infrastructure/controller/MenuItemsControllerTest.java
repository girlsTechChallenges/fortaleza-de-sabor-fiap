...
class MenuItemsControllerTest {
   ...
   @BeforeEach
   public void setUp() {
       menuItemsController = new MenuItemsController(menuItemUseCase, menuMapper);
   }
   ...
   void getAll() throws Exception {
       ...
       when(menuItemUseCase.getAll()).thenReturn(List.of(menuItemMockOne, menuItemMockTwo));
       ...
       // THEN
       verify(menuItemUseCase, times(1)).getAll();
   }
   ...
   void getById() throws Exception {
       ...
       // WHEN
       MockMvc mockMvc = MockMvcBuilders.standaloneSetup(menuItemsController).build();
       when(menuItemUseCase.getById(1L)).thenReturn(Optional.of(menuItem));
       ...
       verify(menuItemUseCase, times(1)).getById(1L);
   }
   ...
   void deleteById() throws Exception {
       ...
       verify(menuItemUseCase, times(1)).deleteById(1L);
   }
   ...
   void shouldUpdateMenuItemSuccessfully() throws Exception {
       ...
       // THEN
       verify(menuItemUseCase, times(1)).update(eq(1L), any(MenuItem.class));
   }
}
