...
(1, 'Restaurante Italiano', 'ITALIANA', 1),
(2, 'Restaurante Brasileiro', 'BRASILEIRA', 2),
(3, 'Restaurante Japonês', 'JAPONESA', 3);

-- Insert addresses for the test restaurants
INSERT INTO enderecos_restaurantes (id, rua, bairro, complemento, numero, estado, cidade, cep, restaurante_id) VALUES
(1, 'Rua Italiana', 'Centro', 'Loja 1', 100, 'SP', 'São Paulo', '01234567', 1),
(2, 'Rua Brasileira', 'Vila Madalena', 'Loja 2', 200, 'SP', 'São Paulo', '02345678', 2),
(3, 'Rua Japonesa', 'Liberdade', 'Loja 3', 300, 'SP', 'São Paulo', '03456789', 3);
