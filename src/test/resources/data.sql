...
INSERT INTO tipos (id, typo)
VALUES
    (1, 'DONO'),
    (2, 'CLIENTE');

-- Inserção de dados na tabela de usuários
INSERT INTO usuarios (id, name, email, login, date_change, type, password)
VALUES
...
INSERT INTO enderecos (id, street, district, complement, number, state, cidy, postCode, usuario_id)
VALUES
